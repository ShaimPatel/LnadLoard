...
class CommercialShowDataWidget extends StatefulWidget {
  ...
  @override
  State<CommercialShowDataWidget> createState() => _CommercialShowDataWidgetState();
}

class _CommercialShowDataWidgetState extends State<CommercialShowDataWidget> {
                ...
                case ConnectionState.done:
                  if (snapshot.hasError || snapshot.data == null) {
                    ...
                    for (int i = 0; i < dataLength.length; i++) {
                      ...
                      if (showData.category == "commercial") {
