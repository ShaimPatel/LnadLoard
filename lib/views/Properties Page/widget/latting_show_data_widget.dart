...
class LattingShowDataWidget extends StatefulWidget {
  const LattingShowDataWidget({Key? key}) : super(key: key);

  @override
  State<LattingShowDataWidget> createState() => _LattingShowDataWidgetState();
}

class _LattingShowDataWidgetState extends State<LattingShowDataWidget> {
